...
| **[DTC Skill Pack](skill-packs/dtc-skill-pack/)** | 6 skills for DTC e-commerce marketing: Klaviyo, Shopify, GA4, Looker Studio, and presentation building. [**Live Demo**](https://thatrebeccarae.github.io/claude-code-skills/skill-packs/dtc-skill-pack/demo/) |
...
| **Pro Deck Builder** | Polished HTML slide decks and PDF-ready reports with dark/light modes |
